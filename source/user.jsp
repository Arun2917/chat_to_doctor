<%-- 
    Document   : user
    Created on : Jan 20, 2023, 1:31:49 PM
    Author     : Java
--%>
					  ...
					  <div class="container-fluid nav-bar">
					    ...
					    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">					      
					      <ul class="nav navbar-nav navbar-right">
					        ...
					        <li><a class="menu active" href="index.html"  style="font-size: 25px;color: black">Home</a></li>
<!--					        <li><a class="menu" href="doctor.jsp" style="font-size: 25px;color: black">Doctor</a></li>
					        <li><a class="menu" href="user.jsp" style="font-size: 25px ;color: black">USer</a></li>
                                                    <li><a class="menu" href="admin.jsp" style="font-size: 25px ;color: black">Admin</a></li>-->
                        ...
                        <form action="registercheck.jsp" method="post" autocomplete="off">
                            ...
                            <p>
                             ...
                             <p>
                                ...
                                <input type="number" class="form-input" name="number" maxlength="10" placeholder="Enter your Phone number" required="">
                            </p>
                            <p>
                                <label for="password">Password</label>
